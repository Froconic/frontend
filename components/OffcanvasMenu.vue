<template>
  ...
  <div class="open-hamberger-wrapper d-none d-lg-block" id="popup-fullscreen-menu" :style="{ backgroundImage: `url('/img/bg/bg-image-54.jpg')` }">
      ...
      <div class="row align-items-end">
        <div class="col-lg-6">
          <div class="info">
            <div class="bk-hover mb--40">
              ...
              <p class="bk_pra font-16">4801 E Colfax <br> Denver, CO 80220</p>
              <p class="bk_pra font-16">
                <a href="mailto:info@yourdomain.com">info@fifteenltd.com</a>
              </p>
            </div>
            <ul class="social-icon text-left tooltip-layout icon-size-large">
              ...
              <li class="instagram">
                <a href="https://www.instagram.com/fifteenltd/" target="_blank" class="link hint--bounce hint--top hint--white" aria-label="Instagram">
        ...
        <div class="col-lg-6">
          <div class="copyright-right text-right">
            <p class="bk_pra font-16">
              &copy; 2022 <b class="text-white">Handcrafted</b> with <i class="fa fa-heart text-danger"></i> by <a href="https://froconicdesign.com/"><b>Froconic Design</b></a>
            </p>
          </div>
        </div>
      </div>
